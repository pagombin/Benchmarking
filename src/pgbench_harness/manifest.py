...
class Manifest:
    ...
    edition: str
    tshirt_size: str
    status: str = "created"  # created|running|complete|partial|failed (+ 'stopped' for continuous)
    mode: str = "sweep"      # sweep | soak | suite | continuous (older manifests default to sweep)
    ...
    continuous: dict[str, Any] = field(default_factory=dict)  # continuous-mode bookkeeping
